...
{
 "use strict";
 var Global,PeityCharts,Client,SC$1,WebSharper,Obj,Peity,UpdatingChart,List,T,Operators,UI,ListModel,Seq,Option,Seq$1,Strings,Client$1,Templates,Doc,JavaScript,Pervasives,Storage,Var,AttrProxy,Enumerator,T$1,Concurrency,EventTarget,Node,JS,Collections,Dictionary,DomUtility,Unchecked,View,Snap,ArrayStorage,Arrays,AsyncBody,SC$2,CT,SC$3,HashSet,WindowOrWorkerGlobalScope,SC$4,Docs,Elt,Array,Object,DocElemNode,CharacterData,Var$1,Scheduler,Error,OperationCanceledException,CancellationTokenSource,DictionaryUtil,Prepare,Slice,KeyCollection,An,Settings,Abbrev,Mailbox,Updates,Attrs,Attrs$1,Dyn,ConcreteVar,Docs$1,RunState,NodeSet,Anims,SC$5,Fresh,SC$6,SC$7,AppendList,HashSetUtil,Easing,HashSet$1,SC$8,Queue,DomNodes,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,Math,IntelliFactory,Runtime,console,$,Date;
 Global=self;
 PeityCharts=Global.PeityCharts=Global.PeityCharts||{};
 Client=PeityCharts.Client=PeityCharts.Client||{};
 SC$1=Global.StartupCode$Peity$Client=Global.StartupCode$Peity$Client||{};
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Obj=WebSharper.Obj=WebSharper.Obj||{};
 Peity=WebSharper.Peity=WebSharper.Peity||{};
 UpdatingChart=Peity.UpdatingChart=Peity.UpdatingChart||{};
 List=WebSharper.List=WebSharper.List||{};
 T=List.T=List.T||{};
 Operators=WebSharper.Operators=WebSharper.Operators||{};
 UI=WebSharper.UI=WebSharper.UI||{};
 ListModel=UI.ListModel=UI.ListModel||{};
 Seq=Peity.Seq=Peity.Seq||{};
 Option=Peity.Option=Peity.Option||{};
 ...
 Client.updateWithRandomNumbers=function(c)
 {
  var b;
  Concurrency.Start((b=null,Concurrency.Delay(function()
  {
   return Concurrency.Bind(Concurrency.Sleep(1000),function()
   {
    ...
    Client.updateWithRandomNumbers(c);
    return Concurrency.Zero();
   });
  })),null);
 };
 Client.chart2=function()
 {
  SC$1.$cctor();
  return SC$1.chart2;
 };
 Client.chart1=function()
 {
  SC$1.$cctor();
  return SC$1.chart1;
 };
 SC$1.$cctor=function()
 {
  ...
  SC$1.chart1=new UpdatingChart.New(T.Empty,null,{
   $:1,
   $0:(r={},r.width=200,r.height=150,r)
  });
  SC$1.chart2=new UpdatingChart.New(T.Empty,{
   $:1,
   $0:10
  },{
   $:1,
   $0:(r$1={},r$1.width=200,r$1.height=150,r$1.fill=["rgba(255,0,0,0.5)"],r$1.stroke=["red"],r$1)
  });
  SC$1.main=(charts=Doc.Element("div",[],[Doc.Element("span",[],[Client.chart1().get_Doc()]),Doc.Element("span",[],[Client.chart2().get_Doc()]),Doc.Element("div",[],[Doc.Button("Add random",[],function()
  {
   var a;
   a=Math.random();
   Client.chart1().AddValue(a);
  })]),Doc.Element("div",[],[Doc.TextNode("Press the button to add a random value to the chart on the left.")])]),(Client.updateWithRandomNumbers(Client.chart2()),Templates.LoadLocalTemplates(""),Doc.RunById("main",charts)));
 };
 ...
 UpdatingChart=Peity.UpdatingChart=Runtime.Class({
  get_Doc:function()
  {
   return this.Doc;
  },
  ...
  {
   var m;
   this.data.Append([this.i[0],v]);
   this.i[0]++;
   m=this.windowSize;
   m==null?void 0:this.data.get_Length()>m.$0?(this.data.RemoveByKey(this.j[0]),this.j[0]++):void 0;
  }
 },Obj,UpdatingChart);
 UpdatingChart.New=Runtime.Ctor(function(data,windowSize,config)
 {
  Obj.New.call(this);
  this.windowSize=windowSize;
  this.data=ListModel.Create(function(t)
  {
   return t[0];
  },Seq.indexed(data));
  this.i=[this.data.get_Length()];
  this.j=[0];
  this.Doc=Doc.BindView(function(s)
  {
   return Doc.Element("span",[AttrProxy.OnAfterRenderImpl(function(e)
   {
    Global.jQuery(e).peity("line",Option.toObj(config));
   })],List.ofSeq(Seq$1.delay(function()
   {
    return[Doc.TextNode(Strings.concat(config==null?",":config.$0.delimiter,Seq$1.map(function(t)
    {
     return Global.String(t[1]);
    },s)))];
   })));
  },this.data.v);
 },UpdatingChart);
 ...
 Option.toObj=function(option)
 {
  return option!=null&&option.$==1?option.$0:null;
 };
 ...
 Prepare.mapHoles=function(t,mappings)
 {
  ...
  DomUtility.IterSelector(t,"[ws-attr-holes]",function(e)
  {
   ...
   for(i=0,$1=holeAttrs.length-1;i<=$1;i++)(function()
   {
    ...
    attrName=Arrays.get(holeAttrs,i);
    return e.setAttribute(attrName,(((Runtime.Curried3(Seq$1.fold))(f))(e.getAttribute(attrName)))(mappings));
   }());
  });
 };
